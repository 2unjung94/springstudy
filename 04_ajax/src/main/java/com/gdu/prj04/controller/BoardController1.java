...
public class BoardController1 {
  ...
  // @ResponseBody - 비동기 ajax 에서 필수! 
  @ResponseBody // 반환 값은 jsp 의 이름이 아닌 어떤 데이터이다(view resolver 가 간섭하지 않도록 하는 annotation)
  @GetMapping(value="/list.do", produces="application/json")  // produces : 응답 데이터 타입 (Content-Type) ajax 작업에서 필수!
