...
public class ContactScheduler {
  ...
  /*
   * 크론(cron)식
   * cronmaker.com 에서 만들 수 있다. (주의; 연도는 없으므로 맨 마지막꺼 빼고 쓸 것)
   * 
   * 1. 형식
   *    초 분 시 일 월 요일
   *    
   ...
   *   3) 시   : 0 ~ 23
   *   4) 일   : 1 ~ 31
   *   5) 월   : 0 ~ 11 (JAN, FEB, MAR, APR, MAY, JUN, JUL, AUG, SEP, OCT, NOV, DEC) (1 ~ 12 아님 주의)
   *   6) 요일 : 0 ~ 7  (SUN, MON, TUE, WED, THR, FRI, SAT, SUN) (SUN = 0 또는 7)
   *   
   * 3. 키워드
   *   1) ? : 설정 없음 (요일)
   *   2) * : 모든 (초 분 시 일 월)
