...
@RequiredArgsConstructor  // final 필드에 생성자로 bean 주입을 위한 annotation
@Repository               // dao bean 생성
public class ContactDaoImpl implements ContactDao {

  private final SqlSessionTemplate sqlSessionTemplate;
  public final static String NS = "com.gdu.prj07.mybatis.mapper.contact_t."; 
